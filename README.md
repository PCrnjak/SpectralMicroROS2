...
**CAN package is currently in progress. You can use ros serial to communicate with Spctral Micro over UART easily.**
The list of commands is here: https://source-robotics.github.io/Spectral-BLDC-docs/apage6_uart/
